...
router.get(routes.map((e) => `${e}/:name`), validSchema(apiAppsV1OpenApiV3), general.findOne(LimitRange));

router.get(['/api/v1/limitranges', ...routes], validSchema(apiV1OpenApiV3), general.list(LimitRange));
