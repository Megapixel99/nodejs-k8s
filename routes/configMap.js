...
router.get([`/api/${ConfigMap.apiVersion}/configmaps`, ...routes], validSchema(apiV1OpenApiV3), general.find(ConfigMap), general.format(ConfigMap), general.list(ConfigMap));
