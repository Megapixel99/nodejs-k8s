...
router.get(routes.map((e) => `${e}/:name`), validSchema(apiAppsV1OpenApiV3), general.findOne(ValidatingWebhookConfiguration));

router.get(['/api/v1/validatingwebhookconfigurations', ...routes], validSchema(apiV1OpenApiV3), general.list(ValidatingWebhookConfiguration));
