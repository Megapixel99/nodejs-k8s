...
router.get(routes.map((e) => `${e}/:name`), validSchema(apiAppsV1OpenApiV3), general.findOne(VolumeAttachment));

router.get(['/api/v1/volumeattachments', ...routes], validSchema(apiV1OpenApiV3), general.list(VolumeAttachment));
