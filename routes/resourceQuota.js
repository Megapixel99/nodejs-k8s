...
router.delete(routes.map((e) => `${e}/:name`), validSchema(apiV1OpenApiV3), general.deleteOne(ResourceQuota), general.sendObj(ResourceQuota));

router.delete(routes, validSchema(apiV1OpenApiV3), general.delete(ResourceQuota), general.sendObj(ResourceQuota));
