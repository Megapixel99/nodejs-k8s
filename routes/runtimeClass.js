...
router.get(routes.map((e) => `${e}/:name`), validSchema(apiAppsV1OpenApiV3), general.findOne(RuntimeClass));

router.get(['/api/v1/runtimeclasses', ...routes], validSchema(apiV1OpenApiV3), general.list(RuntimeClass));
