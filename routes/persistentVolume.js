...
router.get(routes.map((e) => `${e}/:name`), validSchema(apiAppsV1OpenApiV3), general.findOne(PersistentVolume));

router.get(['/api/v1/persistentvolumes', ...routes], validSchema(apiV1OpenApiV3), general.list(PersistentVolume));
