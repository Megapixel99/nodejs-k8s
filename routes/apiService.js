...
router.get(routes.map((e) => `${e}/:name`), validSchema(apiAppsV1OpenApiV3), general.findOne(APIService));

router.get(['/api/v1/apiservices', ...routes], validSchema(apiV1OpenApiV3), general.list(APIService));
