...
router.get(routes.map((e) => `${e}/:name`), validSchema(apiAppsV1OpenApiV3), general.findOne(ControllerRevision));

router.get(['/api/v1/controllerrevisions', ...routes], validSchema(apiV1OpenApiV3), general.list(ControllerRevision));
